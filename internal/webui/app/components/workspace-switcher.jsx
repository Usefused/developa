...
export function WorkspaceSwitcher({repositoryID,repository}) {
  ...
  return <div className="workspace-picker"><span className="workspace-picker-label">Workspace</span>
    ...
    {adding && <AddWorkspaceDialog close={()=>setAdding(false)} added={id=>{setAdding(false);navigate(workspaceURL(pathname,id));}}/>}
  </div>;
}
